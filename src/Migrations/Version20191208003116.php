 ...
 */
final class Version20191208003116 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE clap_entity (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, entity_id INT NOT NULL, row INT NOT NULL, value INT NOT NULL, date DATETIME NOT NULL, INDEX IDX_E455DDC919EB6921 (client_id), INDEX IDX_E455DDC981257D5D (entity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
